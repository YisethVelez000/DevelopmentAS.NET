...
namespace DevelopmentAS.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(DevelopmentAsContext context)
        {
            _context = context;
        }
        ...
        {
            var developmentAsContext = _context.Compras.Include(c => c.IdProveedorNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Idcompra,NombreInsumo,Fecha,Monto,NumCompra,Recibo,Iva,IdProveedor,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idcompra,NombreInsumo,Fecha,Monto,NumCompra,Recibo,Iva,IdProveedor,Total")] Compra compra)
        {
