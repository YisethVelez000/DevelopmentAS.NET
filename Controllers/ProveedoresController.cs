...
namespace DevelopmentAS.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(DevelopmentAsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,NombreProv,NombreContac,Direccion,Correo,Telefono,EstadoProv")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,NombreProv,NombreContac,Direccion,Correo,Telefono,EstadoProv")] Proveedore proveedore)
        {
