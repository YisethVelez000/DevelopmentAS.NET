...
namespace DevelopmentAS.Controllers
{
    public class InsumoesController : Controller
    {
        ...
        public InsumoesController(DevelopmentAsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdInsumo,NombreInsumo,StockInsumo,CantidadInsumo,MedidaInsumo,StockMinInsumo,StockMaxInsumo,ValorInsumo,Iva,EstadoInsumo")] Insumo insumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdInsumo,NombreInsumo,StockInsumo,CantidadInsumo,MedidaInsumo,StockMinInsumo,StockMaxInsumo,ValorInsumo,Iva,EstadoInsumo")] Insumo insumo)
        {
